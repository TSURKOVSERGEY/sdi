...
void ADC_DMA_Config(void)
{
  ...
  DMA_InitStructure.DMA_Memory0BaseAddr = (uint32_t) &raw_buffer[0];
  ...
  #define ADC_SampleTime_My_Cycles ADC_SampleTime_3Cycles
  ...
  ADC_RegularChannelConfig(ADC1,ADC_Channel_4, 16,ADC_SampleTime_My_Cycles);
