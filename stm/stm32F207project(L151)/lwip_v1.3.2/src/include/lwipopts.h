...
#define MEM_SIZE                (16*1032)

/* MEMP_NUM_PBUF: the number of memp struct pbufs. If the application
   sends a lot of data out of ROM (or other static memory), this
   should be set high. */
#define MEMP_NUM_PBUF           1 // 10 new
...
/* MEMP_NUM_TCP_PCB_LISTEN: the number of listening TCP
   connections. */
#define MEMP_NUM_TCP_PCB_LISTEN 1 // 0 new //6
...
#define TCP_MSS                  256 //(1500 - 40)	  /* TCP_MSS = (Ethernet MTU - IP header size - TCP header size) */
